...
Route::get('governmet',[GovernmentController::class,'index'])->name('governmet.index');
Route::get('governmet/create',[GovernmentController::class,'create'])->name('governmet.create');
Route::post('governmet/add',[GovernmentController::class,'store'])->name('governmet.store');
Route::get('governmet/edit/{id}',[GovernmentController::class,'edit'])->name('governmet.edit');
Route::post('governmet/{id}',[GovernmentController::class,'update'])->name('governmet.update');
Route::delete('governmet/{id}',[GovernmentController::class,'destroy'])->name('governmet.destroy');

Route::get('region',[RegionController::class,'indexregion'])->name('region.index');
Route::get('region/create',[RegionController::class,'createregion'])->name('region.create');
