...
<html lang="en">
  <head>
   ...
   <body>
    ...
    <form action="{{ route('adddetails',$product->id) }}"method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text"  name="name"class="form-control" value="{{ $productdetails->name }}" required>
        </div>

        <div class="form-group">
            <label for="discription">Discription</label>
            <textarea name="discription"class="form-control" required>{{ $productdetails->desc }}</textarea>
        </div>

        <div class="form-group">
            <label for="email">Email</label>
            <input type="email"  name="email"class="form-control" value="{{ $productdetails->email }}" required>
        </div>

        <div class="form-group">
            <label for="email">phone</label>
            <input type="number"  name="phone"class="form-control" value="{{ $productdetails->phone }}" required>
        </div>

        <div class="form-group">
            <label for="email">location</label>
<textarea name="location"class="form-control" required>{{ $productdetails->location }}</textarea>
            
        </div>
            
        <div class="form-group">
            <label for="email">mission</label>
            <textarea name="mission" class="form-control" required>{{ $productdetails->mission }}</textarea>
        </div>

        <div class="form-group">
            <label for="email">vision</label>
            <textarea name="vision" class="form-control" required>{{ $productdetails->vision }}</textarea>
        </div>

        <div class="form-group">
            <label for="email">about</label>
            <textarea name="about" class="form-control" required>{{ $productdetails->about }}</textarea>
        </div>
